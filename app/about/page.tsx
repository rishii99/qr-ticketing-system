                    ...
                    <div className="mx-auto max-w-4xl">
                            ...
                            {[
                                {
                                    ...
                                    answer: "TechFest 2025 will be held on July 15, 2025, at Galgotias University, Greater Noida, UP, India. The event will run from 9:00 AM to 6:00 PM."
                                },
                                {
                        ...
                        <div className="text-center mt-8">
                            <p className="text-muted-foreground">
                                ...
                                <a href="mailto:info@qr-ticketing-system.com" className="text-primary hover:underline">
                                    info@qr-ticketing-system.com
                                </a>
                            </p>
                        </div>
                    </div>
                ...
                <div className="container px-4 md:px-6 relative z-10">
                    <div className="mx-auto max-w-3xl text-center space-y-8">
                        ...
                        <div className="flex items-center justify-center space-x-2 text-sm">
                            ...
                            <span>Galgotias University, Greater Noida, UP, India</span>
                        </div>
                    </div>
                </div>
            </section>
